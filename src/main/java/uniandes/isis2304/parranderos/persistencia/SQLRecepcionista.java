...
public class SQLRecepcionista {
	 ...
	 */
	public SQLRecepcionista (PersistenciaHotelAndes pp)
	{
		this.pp = pp;
	}
	 ...
	 */
	public long adicionarSQLRecepcionista (PersistenceManager pm, long numDocu,String tipoDocu,String nombre,String correo,String contrase�a)
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaRecepcionistas()+ "(numDocu,tipoDocu,nombre,correo,contrase�a) values (?,?,?,?,?)");
