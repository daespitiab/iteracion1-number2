...
public class SQLRestaurante {
	 ...
	 */
	public SQLRestaurante (PersistenciaHotelAndes pp)
	{
		this.pp = pp;
	}
	 ...
	 */
	public long adicionarRestaurante (PersistenceManager pm, long idRestaurante, String nombre, long capacidad, String estilo)
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaRestaurantes()+ "(idRestaurante, nombre, capacidad, estilo) values (?, ?, ?, ?)");
        q.setParameters(idRestaurante, nombre, capacidad, estilo);
