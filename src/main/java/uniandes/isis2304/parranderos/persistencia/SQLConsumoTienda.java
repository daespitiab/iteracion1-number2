...
public class SQLConsumoTienda {
	 ...
	 */
	public SQLConsumoTienda (PersistenciaHotelAndes pp)
	{
		this.pp = pp;
	}
	 ...
	 */
	public long adicionarSQLConsumoTienda (PersistenceManager pm, long idProducto, long idCuenta, boolean cargarConsumo)
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaConsumoTienda()+ "(idProducto, idCuenta, cargarConsumo) values ( ?, ?, ?)");
