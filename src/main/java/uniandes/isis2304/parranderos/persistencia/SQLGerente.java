...
public class SQLGerente {
	 ...
	 */
	public SQLGerente (PersistenciaHotelAndes pp)
	{
		this.pp = pp;
	}
	 ...
	 */
	public long adicionarSQLGerente(PersistenceManager pm, long numDocu,String tipoDocu,String nombre,String correo,String contrase�a)
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaGerentes()+ "(numDocu,tipoDocu,nombre,correo,contrase�a) values (?,?,?,?,?)");
